<template>
    <div>
      <!-- 2 -->
    <div class="register" v-if="store.enterRegister">
        <div class="container">
            <form @submit.prevent="register()" >
              ...
              <div class="login-bottom">
                ...
                <input v-model="phone"  type="text" placeholder="+998" />
                <button class="login-btn">Далее</button>
              </div>
            </form>
        </div>
    </div>
    <div class="overlay" v-if="store.enterRegister"></div>
    </div>
</template>
